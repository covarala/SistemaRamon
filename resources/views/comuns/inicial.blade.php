  ...
  <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner">
      <div class="carousel-item active">
        <img class="d-block w-100" src="{{ asset('imagens\BANNER1.png')}}" width="900" height="420" alt="First slide">
      </div>
      <div class="carousel-item">

        <a href="{{route('produtos')}}">
          <img class="d-block w-100"  src="{{ asset('imagens\BANNER-2.png')}}" width="900" height="420" alt="Second slide">
        </a>
      </div>

      <div class="carousel-item">
        <a href="{{route('sobre')}}">
          <img class="d-block w-100" src="{{ asset('imagens\BANNER-3.png')}}" width="900" height="420" alt="Third slide"></a>
        </a>
      </div>
    </div>
